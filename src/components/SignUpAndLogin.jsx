    ...
    <div class="flex items-center justify-center p-2 ">
      <div class="xl:mx-auto  py-2 xl:w-full xl:max-w-sm 2xl:max-w-md">
        ...
        <p class="mt-2 text-base text-gray-700">
          Already have an account? <span onClick={()=>setVisible(false)} className='text-blue-900 cursor-pointer font-bold'> Sign In</span>
        </p>
        <form class="mt-5">
          <div class="space-y-4">
            <div>
  ...
  <section class="rounded-md bg-transparent">
    <div class="flex items-center justify-center p-2 ">
      <div class="xl:mx-auto  py-2 xl:w-full xl:max-w-sm 2xl:max-w-md">
        ...
        <p class="mt-2 text-base text-gray-700">
          Don't have an account? <span onClick={()=>setVisible(true)} className='text-blue-900 font-bold cursor-pointer'> Sign Up</span>
        </p>
        <form class="mt-5">
          <div class="space-y-4">
