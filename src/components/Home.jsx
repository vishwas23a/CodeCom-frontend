...
>
  ...
  >
    <span class="select-none ">SignUp/Login</span>
        ...
        className=" cursor-default flex flex-col mt-12 gap-4 w-full  text-center h-full items-center"> 
            <h1 className="text-6xl font-bold bg-gradient-to-r from-orange-300 to-red-500 bg-clip-text text-transparent">Welcome To </h1>
            <h1 className="text-9xl font-extrabold  bg-gradient-to-r from-orange-500 to-purple-500 bg-clip-text text-transparent">CodeCom</h1>
            <p className="px-16 text-lg text-center mt-2 font-semibold bg-gradient-to-r from-orange-400 to-red-600 bg-clip-text text-transparent">

            Join a vibrant community of coders, collaborate on projects, and level up your skills together. Whether you're a beginner or an expert, connect with like-minded learners, share knowledge, and grow in a supportive environment. Start coding, learning, and building today!
            </p>
        ...
        {showSignUp && 
        (  
        <motion.div  className="w-3/4 z-20" 
        ref={formRef}
